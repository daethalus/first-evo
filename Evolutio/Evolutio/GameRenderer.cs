...
//                        }
//
//                        itensToRender.Add(new RenderItem
//                        {
//                            item = item.Item, screenPosition = new Vector2(x * 16, y * 16), tile = tile, color = color,
...
//                var rotation = 0f;
//                
//                if (Player.AcionedItem.Equals(renderItem.tile.Position))
//                {
